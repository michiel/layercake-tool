...
lazy_static::lazy_static! {
    pub static ref COLLABORATION_EVENTS: layercake_core::utils::EventBroadcaster<String, CollaborationEvent> =
        layercake_core::utils::EventBroadcaster::new(1000);

    pub static ref DELTA_EVENTS: layercake_core::utils::EventBroadcaster<i32, PlanDagDeltaEvent> =
        layercake_core::utils::EventBroadcaster::new(1000);

    pub static ref EXECUTION_STATUS_EVENTS: layercake_core::utils::EventBroadcaster<i32, NodeExecutionStatusEvent> =
        layercake_core::utils::EventBroadcaster::new(1000);
}
