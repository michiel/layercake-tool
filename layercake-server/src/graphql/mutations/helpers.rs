...
pub struct StoredRenderConfig {
    ...
    pub layer_source_styles: Option<Vec<layercake_core::plan::LayerSourceStyleOverride>>,
}
    ...
    pub fn into_render_config(self) -> RenderConfig {
        RenderConfig {
            ...
            note_position: self
                ...
                .unwrap_or(layercake_core::plan::NotePosition::Left),
...
pub fn parse_note_position(value: &str) -> layercake_core::plan::NotePosition {
    match value {
        "right" | "RIGHT" | "Right" => layercake_core::plan::NotePosition::Right,
        "top" | "TOP" | "Top" => layercake_core::plan::NotePosition::Top,
        "bottom" | "BOTTOM" | "Bottom" => layercake_core::plan::NotePosition::Bottom,
        _ => layercake_core::plan::NotePosition::Left,
    }
}
...
pub fn parse_graphviz_comment_style(value: &str) -> layercake_core::plan::GraphvizCommentStyle {
    match value {
        "tooltip" | "TOOLTIP" | "Tooltip" => layercake_core::plan::GraphvizCommentStyle::Tooltip,
        _ => layercake_core::plan::GraphvizCommentStyle::Label,
    }
}
