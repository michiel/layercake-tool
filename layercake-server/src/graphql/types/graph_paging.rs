...
use layercake_core::graph::{Edge, Node};
use layercake_core::services::data_set_service::{GraphPageData, GraphSummaryData};
...
impl From<layercake_core::graph::Layer> for LayerSlice {
    fn from(l: layercake_core::graph::Layer) -> Self {
        LayerSlice {
            id: l.id,
            label: l.label,
