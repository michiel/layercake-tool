...
impl TransformNodeConfig {
    ...
    pub fn to_graph_config(&self) -> layercake_core::plan::GraphConfig {
        let mut config = layercake_core::plan::GraphConfig::default();
...
mod tests {
    use super::*;
    use layercake_core::graph::{Edge, Layer, Node};
