...
use crate::chat::{ChatEvent, ChatProvider};
...
impl From<layercake_core::database::entities::chat_sessions::Model> for ChatSession {
    fn from(model: layercake_core::database::entities::chat_sessions::Model) -> Self {
        Self {
            id: model.id,
...
impl From<layercake_core::database::entities::chat_messages::Model> for ChatMessage {
    fn from(model: layercake_core::database::entities::chat_messages::Model) -> Self {
        Self {
            id: model.id,
            session_id: model.session_id,
...
impl From<layercake_core::database::entities::users::Model> for McpAgent {
    fn from(model: layercake_core::database::entities::users::Model) -> Self {
        Self {
            id: model.id,
...
impl From<layercake_core::services::mcp_agent_service::McpAgentCredentials> for McpAgentCredentials {
    fn from(creds: layercake_core::services::mcp_agent_service::McpAgentCredentials) -> Self {
        Self {
