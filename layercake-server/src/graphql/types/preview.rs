...
impl From<layercake_core::database::entities::graph_data_edges::Model> for GraphEdgePreview {
    fn from(model: layercake_core::database::entities::graph_data_edges::Model) -> Self {
        Self {
            id: model.external_id,
            source: model.source,
            target: model.target,
