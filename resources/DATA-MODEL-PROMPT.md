# The layercake platform

Layercake is a graph construction, transformation and export platform. A project has a directed acyclic graph (DAG) representing the relationship between each aspect. As an example, a project might have 3 data sources for nodes, layers, edges, combine these using a merge operation, send this to a graph and then export the graph to different formats.
