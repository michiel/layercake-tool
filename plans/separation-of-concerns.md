...
**Next steps**
- Continue wiring Actor into remaining mutation paths (audit GraphQL mutations and MCP tool entrypoints for graph data edits, library item management, collaboration, projection, and sequence flows).
