...
| Project/graph mutation migration | Next up: convert the remaining project/graph/collaboration GraphQL mutations (see remaining `Error::new` hits around lines 456–3281) to `StructuredError`. | Pending |  |
